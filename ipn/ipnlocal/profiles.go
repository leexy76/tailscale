...
// SetPrefs sets the current profile's prefs to the provided value. It also
// saves the prefs to the StateStore. If the currnet profile is named, it stores
// a copy of the provided prefs, which maybe accessed via CurrentPrefs.
